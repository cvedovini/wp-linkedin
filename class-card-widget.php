...
<p>
	...
	<input id="<?php echo $this->get_field_id('picture_width'); ?>" name="<?php echo $this->get_field_name('picture_width'); ?>" type="text" value="<?php echo $instance['picture_width']; ?>" />
</p>
<p>
	<label for="<?php echo $this->get_field_id('summary_length'); ?>"><?php _e('Max length of summary (in char):', 'wp-linkedin'); ?></label>
	<input id="<?php echo $this->get_field_id('summary_length'); ?>" name="<?php echo $this->get_field_name('summary_length'); ?>" type="text" value="<?php echo $instance['summary_length']; ?>" />
